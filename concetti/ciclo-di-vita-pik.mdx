...
L'allievo può anche **acquistare la PIK sul sito**. Prima del pagamento indica (tutti opzionali) istruttore, training facility e dati per l'eventuale fattura. Dopo il pagamento la PIK nasce **Acquistata** in stato **Creato**; se c'è un istruttore parte subito la richiesta di accettazione.
