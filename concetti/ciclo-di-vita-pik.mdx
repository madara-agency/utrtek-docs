...
<Note>
  Se l'istruttore **rifiuta**, la PIK **non si chiude**: torna a **Creato** senza istruttore, così si può riassegnare. L'esito **Non promosso** si usa solo alla chiusura del corso.
</Note>
...
L'allievo può anche **acquistare la PIK sul sito** (carta, PayPal o bonifico). Prima del pagamento indica (tutti opzionali) istruttore, training facility e dati per l'eventuale fattura. Dopo il pagamento confermato la PIK nasce **Acquistata** in stato **Creato**; se c'è un istruttore parte subito la richiesta di accettazione. Con il bonifico la PIK parte solo quando la segreteria conferma l'accredito in Ordini sito.
...
Allievo, istruttore e acquirente ricevono le email di iscrizione/apertura/chiusura/sospensione, tranne chi ha eseguito l'azione. Dettaglio: [Notifiche](/email/notifiche).
